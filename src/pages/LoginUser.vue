<template>
  <div class="w-[100%] h-[100%]">
    <!-- Login Text -->
    <div
      class="w-[400px] h-[400px] bg-gray-600 rounded-xl mx-auto my-28 border-2 border-gray-200">
      <div
        class="text-white text-4xl font-bold text-center glowing-text mt-20"
        style="
      ...
      <div class="mt-20 ml-2">
        <button
          type="button"
          class="ml-[25%] text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2 mb-2">
          <svg
